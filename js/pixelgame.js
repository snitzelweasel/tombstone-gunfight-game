class PixelTombstoneGame {
    ...
    playerShoot(x, y) {
        ...
        if (this.isMultiplayer && this.multiplayerManager) {
            this.multiplayerManager.playerShoot(x, y, hit);
        }
        ...
        if (hit) {
            ...
            if (isKillShot) {
                ...
                if (this.isMultiplayer && this.multiplayerManager) {
                    this.multiplayerManager.getOtherPlayers().then(otherPlayers => {
                        if (otherPlayers.length > 0) {
                            this.multiplayerManager.updateHealth(otherPlayers[0].playerId, 0);
                        }
                    });
                }
                ...
                if (this.isMultiplayer && this.multiplayerManager) {
                    this.multiplayerManager.getOtherPlayers().then(otherPlayers => {
                        if (otherPlayers.length > 0) {
                            this.multiplayerManager.updateHealth(otherPlayers[0].playerId, this.opponentHealth);
                        }
                    });
                }
            }
